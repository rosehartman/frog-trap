...
lamdiffads = qplot(levels, ldiff, data= summaryads2, geom="line", color=stage, xlab= "increase in survival", ylab="difference in lambda", main = "Predation on adults, juveniles migrate")
